export function MerchantDashboardMockup() {
  ...
  return (
    <div className="dashboard-showcase bo-dashboard-showcase merchant-dashboard" aria-label="Aperçu de l'espace commerçant WALS avec données d'exemple">
      <div className="dashboard-frame dashboard-desktop">
        ...
        <div className="dashboard-body">
          <aside className="dashboard-sidebar"><div className="dashboard-brand"><span>W</span><strong>LE FOURNIL</strong></div><nav aria-label="Aperçu des sections commerce"><span className="active">Vue d'ensemble</span><span>Clients</span><span>Fidélité</span><span>Campagnes</span><span>Statistiques</span></nav><div className="sidebar-status"><i /> Aperçu espace commerce</div></aside>
          <div className="dashboard-main">
            <div className="dashboard-heading"><div><span>EXEMPLE DE TABLEAU DE BORD</span><h3>Votre fidélité.</h3></div><div className="dashboard-cta">+ Nouvelle action</div></div>
      ...
      <p className="dashboard-demo-note">Données d'exemple présentées à titre illustratif.</p>
    </div>
  );
}
